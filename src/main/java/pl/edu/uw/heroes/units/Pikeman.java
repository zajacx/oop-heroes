...
public class Pikeman extends Unit {
    ...
    @Getter
    private final int baseAttack = 4, baseDefense = 3, baseSpeed = 4,
            singleArrows = 0, singleHealth = 10, minDamage = 1, maxDamage = 3;
    ...
    public Pikeman(int n, Player owner) {
        this.owner = owner;
        this.armySize = n;
    ...
    public void doAttack(Field aim) {
        ...
        // There is always a bonus or a reduction, so the result will always be of a type double.
